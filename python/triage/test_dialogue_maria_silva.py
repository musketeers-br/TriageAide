...
PATIENT_RESPONSES = [
    "I want to start triage for patient Maria Silva",
    "Not doing well, I'm feeling very thirsty and tired",
    "Yes, I've noticed I'm urinating much more than usual",
    "No, my vision is normal",
    "Yes, sometimes I feel dizzy",
    "No, I haven't noticed leg swelling",
]
...
async def run_test():
    ...
    print("\n" + "=" * 70)
    print("DIALOGUE QUALITY TEST — MARIA SILVA")
    print("=" * 70)
    ...
    has_fhir_context = any(
        any(kw in t["agent"].lower() for kw in ["diabetes", "hypertens", "medical record", "fhir", "medication", "warfarin", "heart failure"])
